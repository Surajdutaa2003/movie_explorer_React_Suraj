            ...
            <div className="relative group">
              ...
              <div className="absolute right-0 mt-2 w-48 bg-white rounded-lg shadow-lg dropdown-menu">
                <button
                  ...
                  className="block w-full text-left px-4 py-3 text-sm text-gray-700 hover:bg-gradient-to-r hover:from-red-500 hover:to-red-600 hover:text-white transition-all duration-300 rounded-lg flex items-center space-x-2"
                >
                  <svg 
      ...
      {menuOpen && (
        <div className="md:hidden bg-white p-4 border-b border-gray-200 shadow-lg">
          <div className="flex flex-col space-y-2">
            ...
            <button
              onClick={handleLogout}
              className="w-full text-left px-4 py-3 text-sm font-medium text-gray-700 hover:bg-gradient-to-r hover:from-red-500 hover:to-red-600 hover:text-white transition-all duration-300 rounded-lg flex items-center space-x-2"
            >
              <svg 
                xmlns="http://www.w3.org/2000/svg" 
                className="h-5 w-5" 
