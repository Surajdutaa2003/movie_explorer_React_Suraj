...
const MovieList: React.FC<MovieListProps> = ({ movies, onMovieClick, onDeleteMovie }) => {
  ...
  // Filter movies with rating >= 8.5 for All time Favourites
  ...
  const topActors = [
    ...
    { name: 'Robert Pattinson', image: 'https://encrypted-tbn0.gstatic.com/images?q=tbngcSPamFqYRka1uW1pUEdbsbaNzFIpA9_sXRbwL5RZcUrQWdE9YgsnPWplAnG1JSIWVb-GLk&usqp=CAU' },
  ];
    ...
    <div className="space-y-12 px-4">
      ...
      <section>
        ...
        {movies.length > 0 ? (
          ...
          >
            ...
            <button
              className="custom-prev-all absolute top-1/2 left-0 transform -translate-y-1/2 text-gray-800 bg-white p-2 rounded-full shadow-lg cursor-pointer z-10"
              aria-label="Previous slide"
            >
              ←
            </button>
            <button
              className="custom-next-all absolute top-1/2 right-0 transform -translate-y-1/2 text-gray-800 bg-white p-2 rounded-full shadow-lg cursor-pointer z-10"
      ...
      <section>
        ...
        {trendingMovies.length > 0 ? (
          ...
          >
            ...
            <button
              className="custom-prev-trending absolute top-1/2 left-0 transform -translate-y-1/2 text-gray-800 bg-white p-2 rounded-full shadow-lg cursor-pointer z-10"
              aria-label="Previous slide"
            >
              ←
            </button>
            <button
              className="custom-next-trending absolute top-1/2 right-0 transform -translate-y-1/2 text-gray-800 bg-white p-2 rounded-full shadow-lg cursor-pointer z-10"
              aria-label="Next slide"
            >
              →
            </button>
      ...
      <section>
        ...
        {allTimeFavorites.length > 0 ? (
          ...
          >
            ...
            <button
              className="custom-prev-top absolute top-1/2 left-0 transform -translate-y-1/2 text-gray-800 bg-white p-2 rounded-full shadow-lg cursor-pointer z-10"
              aria-label="Previous slide"
            >
              ←
            </button>
            <button
              className="custom-next-top absolute top-1/2 right-0 transform -translate-y-1/2 text-gray-800 bg-white p-2 rounded-full shadow-lg cursor-pointer z-10"
              aria-label="Next slide"
            >
              →
            </button>
          ...
          <p className="text-gray-500">No movies with rating 8.5 or higher available.</p>
        )}
      </section>
      ...
      <section>
        ...
        >
          ...
          <button
            className="custom-prev-actors absolute top-1/2 left-0 transform -translate-y-1/2 text-gray-800 bg-white p-2 rounded-full shadow-lg cursor-pointer z-10"
            aria-label="Previous slide"
          >
            ←
          </button>
          <button
            className="custom-next-actors absolute top-1/2 right-0 transform -translate-y-1/2 text-gray-800 bg-white p-2 rounded-full shadow-lg cursor-pointer z-10"
            aria-label="Next slide"
          >
            →
          </button>
